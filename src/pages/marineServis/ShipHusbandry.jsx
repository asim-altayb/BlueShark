...
import gedo2 from "../../assets/offshore.mp4"
import hus from "../../assets/works (7).jpg"
import hus7 from "../../assets/works (9).jpg"
import hus8 from "../../assets/works (2).jpg"
import hus9 from "../../assets/works (4).jpg"
import hus2 from "../../assets/work (38).jpg"
import hus3 from "../../assets/work (39).jpg"
import hus4 from "../../assets/work (36).jpg"
import hus5 from "../../assets/work (41).jpg"
import hus6 from "../../assets/work (37).jpg"
import hus10 from "../../assets/work (40).jpg"
import gedo1 from "../../assets/marine (4).mp4"
import hus11 from "../../assets/shipsuplly (13).jpg"
import hus12 from "../../assets/shipsuplly (14).jpg"
import hus13 from "../../assets/shipsuplly (15).jpg"
import hus14 from "../../assets/shipsuplly (16).jpg"
import hus15 from "../../assets/shipsuplly (17).jpg"
...
function ShipHusbandry() {
  ...
  const images = [hus,
    ...
    hus14,
    hus15,
    hus9, hus2, hus3, hus5, hus6, hus4, hus10, hus11]
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:3001/ShipHusbandry', formData);
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
        <img src={sanga3} className="absolute inset-0 w-full h-full object-cover" alt="Ship Husbandry Hero" />
        <div className="absolute inset-0 bg-gradient-to-r from-slate-900/90 via-teal-900/80 to-slate-900/60"></div>
        ...
        <div className="relative z-10 text-center text-white p-6 max-w-4xl mx-auto">
          ...
          <h1 data-aos="fade-up" className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 drop-shadow-2xl">
            Ship <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-300">Husbandry</span>
          </h1>
      ...
      <div className="relative -mt-20 z-20 pb-20 px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden border border-slate-200">
          <div className="bg-slate-900 py-6 px-8 border-b border-slate-800">
            ...
            <p className="text-slate-400 mt-1 pl-5">Comprehensive ship husbandry and support services.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div data-aos="fade-up">
                ...
                <input onChange={handleChange} type='text' value={formData.name} id="first-name" name="name" autoComplete="given-name"
                  className="w-full bg-slate-50 border border-slate-300 text-slate-900 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 block p-3 transition-colors" />
              </div>
              ...
              <div data-aos="fade-up" className="md:col-span-2">
                ...
                <input onChange={handleChange} id="date" type="date" value={formData.date} name="date" autoComplete="bday"
                  className="w-full md:w-1/2 bg-slate-50 border border-slate-300 text-slate-900 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 block p-3 transition-colors" />
              </div>
            </div>

            {/* Service Selection */}
            <div data-aos="fade-up" className="bg-slate-50 p-6 rounded-lg border border-slate-200">
              <label className="block text-lg font-bold text-slate-800 mb-4 border-b border-slate-300 pb-2">Husbandry Services</label>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  "CCTV Class (UWILD)", "Hull Cleaning", "Anode Inspection & Replacment",
                  "Propeller Super Plolishing", "Propeller Blade Repair", "Sea Chest Blanking $ plugging",
                  "Cofferdam Installation For Afloat Repair", "Underwater Cutting & Welding", "Thruster Pull-Out & installation",
                  "Speed Log & Echo Sounder Pull-Out", "Underwater Ultrasonic Thickness Gauging"
                ].map((service) => (
                  <label key={service} className="flex items-center space-x-3 p-3 bg-white border border-slate-200 rounded hover:border-teal-400 transition-colors cursor-pointer">
                    <input type="checkbox" onChange={handleCheckbox} value={service} className="w-5 h-5 text-teal-600 bg-gray-100 border-gray-300 rounded focus:ring-teal-500" />
            ...
            {/* Details Letter */}
            <div data-aos="fade-up">
              <label htmlFor="about" className="block text-sm font-bold text-slate-700 mb-2">Details Letter</label>
      ...
      <div className="py-20 bg-slate-100 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6">

          {/* Videos */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div data-aos="fade-right" className="bg-black rounded-xl overflow-hidden shadow-xl border border-slate-700">
              <video loop controls playsInline className="w-full h-full object-cover">
                <source src={gedo2}></source>
              </video>
            </div>
            <div data-aos="fade-left" className="bg-black rounded-xl overflow-hidden shadow-xl border border-slate-700">
              <video loop controls playsInline className="w-full h-full object-cover">
                <source src={gedo1}></source>
              </video>
            </div>
          </div>

          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-4xl font-bold text-slate-900 mb-2 font-serif">Ship Husbandry Gallery</h2>
          ...
          <div data-aos="fade-up" className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8'>
            {images.map((image, index) => (
              <div key={index} className="group overflow-hidden rounded-xl shadow-lg border border-slate-200 bg-white">
                <img src={image} className="w-full h-64 object-cover transform transition-transform duration-500 group-hover:scale-110" alt={`Husbandry Gallery ${index}`} />
              </div>
            ))}
          </div>
        </div>
